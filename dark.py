...
ADMIN_IDS = [1957692504]
BOT_TOKEN = "7707386509:AAFDFFJnLAeEuX3l-vkXzgy4Ls_d9z3VCrc"
thread_count = 900
packet_size = 9
...
def process_attack_command(message, chat_id):
    try:
        ...
        if len(args) != 3:
            bot.send_message(chat_id, "Invalid command format. Please use: @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅", parse_mode='Markdown')
            return
...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜"  
...
def send_welcome(message):
    ...
    if is_super_admin(user_id):
        welcome_message = (
            f"𝐖𝐞𝐥𝐜𝐨𝐦𝐞, 𝐒𝐮𝐩𝐞𝐫 𝐀𝐝𝐦𝐢𝐧 𝗠𝗮𝗻𝗶𝘀𝗵๛𝗦𝗶𝗻𝗴𝗵! 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐝 𝐁𝐲 ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜\n\n"
            f"𝐀𝐝𝐦𝐢𝐧 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:\n"
        ...
        balance = get_admin_balance(user_id)
        welcome_message = (
            f"Welcome, Admin! Developed By ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜\n\n"
...
def attack_button_handler(message):
    ...
    if not found_user:
        bot.send_message(chat_id, "*𝐘𝐨𝐮 𝐚𝐫𝐞 𝐧𝐨𝐭 𝐫𝐞𝐠𝐢𝐬𝐭𝐞𝐫𝐞𝐝. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐫𝐞𝐝𝐞𝐞𝐦 𝐀 𝐤𝐞𝐲 𝐓𝐨 𝐎𝐰𝐧𝐞𝐫:- ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜*", parse_mode='Markdown')
        return

    valid_until = datetime.fromisoformat(found_user['valid_until'])
    if datetime.now() > valid_until:
        bot.send_message(chat_id, "*𝐘𝐨𝐮𝐫 𝐤𝐞𝐲 𝐡𝐚𝐬 𝐞𝐱𝐩𝐢𝐫𝐞𝐝. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐫𝐞𝐝𝐞𝐞𝐦 𝐀 𝐤𝐞𝐲 𝐓𝐨 𝐎𝐰𝐧𝐞𝐫:- ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜.*", parse_mode='Markdown')
        return
    ...
    if is_super_admin(user_id):
        ...
        if datetime.now() > datetime.fromisoformat(found_user['valid_until']):
            account_info = (
                ...
                "Contact ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜ for assistance."
            )
        else:
            account_info = (
        ...
        account_info = "𝐏𝐥𝐞𝐚𝐬𝐞 𝐫𝐞𝐝𝐞𝐞𝐦 𝐀 𝐤𝐞𝐲 𝐓𝐨 𝐎𝐰𝐧𝐞𝐫:- ᚛ @𝗠𝗮𝗻𝗶𝘀𝗵8𝘅 ᚜."
